            ...
            {activeTab === "SETTINGS" && (
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: 20 }} className="absolute inset-0 bg-[#010409] z-[60] flex flex-col items-center justify-center p-20">
                    <div className="w-full max-w-md space-y-12">
                        ...
                        <button onClick={() => setActiveTab("VOICE")} className="w-full py-4 bg-pink-600 text-white text-[10px] tracking-[0.4em] uppercase rounded-lg hover:bg-pink-500 transition-all">Apply Configuration</button>
                    </div>
                </motion.div>
            )}
          </AnimatePresence>
